...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFF]">
      ...
      <section id="features" className="relative py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <div className="inline-flex items-center space-x-2 px-4 py-2 bg-[#1FB6A6]/10 rounded-full mb-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((feature, index) => (
              <div
                key={index}
                className={`group bg-white rounded-xl p-6 border-2 border-[#EEF2FF] hover:border-[#6C63FF]/30 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 ${feature.bgColor}`}
              >
      ...
      {/* Modes Section */}
      <section id="modes" className="relative py-20 px-4 sm:px-6 lg:px-8 bg-[#EEF2FF]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <div className="inline-flex items-center space-x-2 px-4 py-2 bg-white rounded-full mb-4 border border-[#6C63FF]/20 shadow-sm">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {modes.map((mode, index) => (
              <div
                key={index}
                className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border-2 border-[#EEF2FF] hover:border-[#6C63FF]/30"
              >
      ...
      <section id="benefits" className="relative py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
