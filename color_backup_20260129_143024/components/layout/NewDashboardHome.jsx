      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid lg:grid-cols-3 gap-6 mb-8">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-br from-purple-50 to-blue-50 dark:from-purple-900/20 dark:to-blue-900/20 rounded-2xl shadow-lg p-6 border border-purple-200 dark:border-purple-800">
              <div className="flex items-center gap-2 mb-3">
              ...
              <Link
                ...
                className="block w-full px-4 py-3 bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white text-center font-medium rounded-lg transition-all shadow-md"
              >
                Explore Community
